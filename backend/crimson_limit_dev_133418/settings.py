"""
Django settings for crimson_limit_dev_133418 project.
...
ROOT_URLCONF = 'crimson_limit_dev_133418.urls'
...
WSGI_APPLICATION = 'crimson_limit_dev_133418.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crimson_limit_dev_133418 API",
    "DESCRIPTION": "API documentation for crimson_limit_dev_133418 App",
    "VERSION": "v1",
}
